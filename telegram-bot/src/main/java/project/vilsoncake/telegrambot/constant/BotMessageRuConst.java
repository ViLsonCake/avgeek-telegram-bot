...
public class BotMessageRuConst {
    public static final String START_TEXT = """
            ...
            *Теперь давайте выберем интересующий вас аэропорт*
            ...
            Название аэропорта и скобки писать не требуется, только код.
            
            Вы можете узнать его на [Flightradar24](https://www.flightradar24.com).
            
            *Обратите внимание!* Бот начнет работу только после выбора аэропорта.
            """;
    ...
    public static final String FLIGHT_TEXT = """
            ...
            ✈️ [Информация о воздушном судне](https://www.flightradar24.com/data/aircraft/%s)
    ...
    public static final String CHOOSING_MODE_TEXT = """
            ...
            All - Вы будете получать оповещения о полетах Ан-124, *а также* о полетах широкофюзеляжных самолетов в ваш аэропорт.
            
            Wide-body - Вы будете получать оповещения *только* о полетах широкофюзеляжных самолетов в ваш аэропорт.
            
            An-124 - Вы будете получать оповещения *только* о полетах Ан-124.
            
            Mute - Вы не будете получать *никаких* уведомлений.
            """;
    ...
    public static final String CHOSEN_MAX_AIRCRAFT_COUNT_TEXT = """
            ...
            Если вы снова хотите отслеживать все широкофюзеляжные самолеты, используйте команду /selectaircraft и нажмите на ❌ не выбирая ни одно воздушное судно.
            """;
    ...
    public static final String USER_NOT_HAVE_CHOSEN_AIRCRAFT_TEXT = "Вы будете получать уведомления обо всех широкофюзеляжных самолетах, если вы хотите выбрать конкретные воздушные суда, используйте команду /selectaircraft.";
}
