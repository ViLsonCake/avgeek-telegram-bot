...
public class BotMessageUkConst {
    public static final String START_TEXT = """
            ...
            *Що вміє цей бот?*
            ...
            ✅ Ви можете відстежувати конкретні *широкофюзеляжні авіалайнери*, наприклад тільки Boeing 747 або Airbus A350 і Airbus A380, ви можете вибрати від 1 до 5 авіалайнерів.
    ...
    public static final String CHOOSING_MODE_TEXT = """
            ...
            All - Ви будете отримувати сповіщення про польоти Ан-124 *а також* про польоти широкофюзеляжних літаках летящих у ваш аеропорт.
            
            Wide-body - Ви будете отримувати сповіщення *тільки* про польоти широкофюзеляжних літаків у ваш аеропорт.
            
            An-124 - Ви будете отримувати сповіщення *тільки* про польоти Ан-124.
            
            Mute - Ви не будете отримувати *ніяких* сповіщень.
            """;
